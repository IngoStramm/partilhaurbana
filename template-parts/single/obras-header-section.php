...
<div class="col-md-12">
    <div class="projetos-header">
        <div class="d-flex align-items-center justify-content-between gap-4 mb-4">
            <h2 class="section-title mb-0"><?php echo get_the_title($post_id); ?></h2>
            <a href="<?php echo get_permalink($post_id); ?>" class="btn btn-secondary btn-with-icon">
        ...
        <?php get_template_part('template-parts/general/obra', 'item', array('post_id' => $post_id)); ?>
    </div>
</div>