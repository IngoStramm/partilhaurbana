...
<div class="row mt-3">
    <div class="col-md-12 d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
        <input class="form-control search-input" type="text" name="search-documentos" id="search-documentos" aria-label="<?php _e('Buscar', 'pu'); ?>" placeholder="<?php _e('Buscar', 'pu'); ?>">
        <a
            href="#"
            class="btn btn-secondary btn-with-icon flex-shrink-0"
            data-bs-toggle="modal"
            data-bs-target="#modal-editar-documento-obra">
    ...
    <div class="col-md-12">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <div class="table-responsive" id="table-documento-obra">
